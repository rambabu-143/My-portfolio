...
const Footer = () => {
  ...
  return (
    <footer className="relative py-12 overflow-hidden border-t border-white/10">
      ...
      <motion.div
        className="absolute bottom-0 left-1/4 w-64 h-64 bg-white/3 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-0 right-1/4 w-64 h-64 bg-white/2 rounded-full blur-3xl"
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.5, 0.3, 0.5],
        }}
